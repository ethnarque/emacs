;;; init-treesitter.el --- Insert description here -*- lexical-binding: t -*-
;;; Commentary:
;;; Code:

;;; Enable built-in and pre-installed TS modes if the grammars are available

(defun secretaire/auto-configure-treesitter ()
...
(secretaire/remap-ts-mode 'js2-mode 'js-ts-mode 'javascript)
